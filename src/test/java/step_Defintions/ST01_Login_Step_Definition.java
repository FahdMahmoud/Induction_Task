...
import static step_Defintions.Setup.*;
...
public class ST01_Login_Step_Definition {
    ...
    public void Login_Fail_FieldRequired() {
        ...
        soft.assertEquals(Expected_result, Actual_result_User, "Assert on (Required) (User_err_msg) is appeared");
        soft.assertEquals(Expected_result, Actual_result_Pass, "Assert on (Required) (Pass_err_msg) is appeared");
    ...
    public void Invalid_Credentials() {
        ...
        soft.assertEquals(Expected_result, Actual_result, "Assert on (Invalid Credentials) keyword is appeared");
    ...
    public void Login_Success() {
        ...
        soft.assertTrue(Expected_result.equals(Actual_result), "Assert That user directed to dashboard page and Dashboard title is appeared");

        // Assert that user is Login successfully and directed to dashboard page and Dashboard dropdown is appeared
        //wait.until(ExpectedConditions.elementToBeClickable(Dashboard.User_Profile_Assertion on the dashboard title on the dash board dropDown()));
